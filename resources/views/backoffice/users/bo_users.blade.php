<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-row justify-around">
                    ...
                    <div>
                        <a href="{{ route('users.create') }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
    ...
    <div class="py-12">
        <div class="container mx-auto">
            <h2 class="text-xl font-semibold m-4"> Liste des utilisateurs </h2>

            @include('includes._backoffice._message_flash')

            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                @include('includes._backoffice._users._table_users')
            </div>
        </div>
    </div>
</x-app-layout>
