<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Gender -->
        <x-input-label class="required" for="gender" :value="__('Genre')" />
        ...
        <!-- Lastname -->
        <div>
            <x-input-label class="required" for="lastname" :value="__('Nom')" />
        ...
        <!-- Firstname -->
        <div>
            <x-input-label class="required" for="firstname" :value="__('Prénom')" />
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-input-label class="required" for="email" :value="__('E-mail')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="required" for="password" :value="__('Mot de passe')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label class="required" for="password_confirmation" :value="__('Confirmer mot de passe')" />

            <x-text-input id="password_confirmation" class="block mt-1 w-full required"
                            type="password"
        ...
        <!-- Tel port -->
        <div>
            <x-input-label class="required" for="phone2" :value="__('Téléphone portable')" />
