@auth
    <button data-modal-target="cart-popup-modal" data-modal-toggle="cart-popup-modal" class=" m-2 block text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="button">
        <i class="fa-solid fa-check"></i> Confirmer mes achats
    </button>

    <div id="cart-popup-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
...
@else
    @include('includes._cart._modal_connect_cart')
@endauth
