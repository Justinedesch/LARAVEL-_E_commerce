<div class="container mx-auto flex justify-center items-center">
    <form class="w-full" action="{{ route('categories.store') }}" method="post">
        ...
        <div class="relative z-0 w-full mb-6 group">
            ...
            <label for="floating_link" class="required peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Texte de lien</label>
        </div>
        <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:green:bg-blue-700 dark:focus:ring-green-800"><i class="fa-solid fa-floppy-disk"></i> Créer la catégorie</button>
    </form>
</div>
